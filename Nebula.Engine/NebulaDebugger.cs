...
using Nebula.Engine.Assets;
using Nebula.JsonRpc;
...
public static class NebulaDebugger
{
    ...
    private static void RegisterMethods(IJsonRpcServer server)
    {
        ...
        {
            { "nebulaVersion", NebulaEngine.NebulaVersion },
            { "glVersion", NebulaEngine.GlVersion },
            { "glRenderer", NebulaEngine.GlRenderer },
        });
        ...
        server.RegisterMethod("CreateAndLoadProject", param =>
        {
            ...
            NebulaEngine.ActiveProject = project;
        ...
        server.RegisterMethod("UnloadProject", () => NebulaEngine.ActiveProject = null);

        server.RegisterMethod("SaveProject", () => NebulaEngine.ActiveProject?.Save());
        ...
        {
            var scene = NebulaEngine.ActiveProject!.Bundle.GetAsset<Scene>("scenes", Guid.Parse(param!["guid"]!.GetValue<string>()));
